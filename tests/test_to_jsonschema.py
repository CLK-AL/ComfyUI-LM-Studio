...
def test_openapi_converter_emits_operations_with_schemas():
    from comfyui_openapi_node.to_jsonschema import openapi as oas
    spec = {
        "openapi": "3.0.3",
...
def test_openapi_converter_then_binding_produces_comfy_spec():
    from comfyui_openapi_node.to_jsonschema import openapi as oas
    from comfyui_openapi_node.binding import (
...
def test_asyncapi_converter_smoke():
    from comfyui_openapi_node.to_jsonschema import asyncapi as aas
    spec = {
        "asyncapi": "2.6.0",
...
def test_mcp_converter_smoke():
    from comfyui_openapi_node.to_jsonschema import mcp
    tools = [
        {"name": "echo",
         "description": "",
