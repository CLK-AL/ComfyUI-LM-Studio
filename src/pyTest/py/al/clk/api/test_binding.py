...
def test_expand_resolves_ref():
    from al.clk.api.binding import expand, resolve_ref
...
def test_operation_to_input_types_splits_required_and_optional():
    from al.clk.api.binding import operation_to_input_types
    op = {
        "parameters": [
...
def test_operation_to_return_types_prepends_typed_fields():
    from al.clk.api.binding import operation_to_return_types
